...
print("Input for all")
mirage_input_all <- read.table("/project/xinhe/xsun/rare_variants/5.revision/data/mirage_input_20231013.txt")
...
print("Input for ASC")
mirage_input_asc <-  read.table("/project/xinhe/xsun/rare_variants/5.revision/data/ASC/mirage_input.txt")
...
mirage_input_spark <- read.table("/project/xinhe/xsun/rare_variants/5.revision/data/SPARK/mirage_input.txt")
