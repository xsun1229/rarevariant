---
title: "Comparing results from ASC, SPARK, and collectively, only missense updated"
author: "XSun"
date: "2025-07-01"
output:
...
print("Input for all")
mirage_input_all <- readRDS("/project/xinhe/xsun/rare_variants/5.revision/data/mirage_input_misupdated.RDS")
...
print("Input for ASC")
mirage_input_asc <- readRDS("/project/xinhe/xsun/rare_variants/5.revision/data/mirage_input_ASC_misupdated.RDS")
...
mirage_input_spark <- readRDS("/project/xinhe/xsun/rare_variants/5.revision/data/mirage_input_SPARK_misupdated.RDS")
...
```{r fig.height=3, fig.width=7 , warning=F, message=FALSE}
mirage_res_asc <- readRDS("/project/xinhe/xsun/rare_variants/5.revision/results/mirage_res/mirage_ASC_misupdated.RDS")
...
pval_all <- mirage_res_all$eta.pvalue[c("1","2","3","4","5","6")]
```
